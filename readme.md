# YOLOv11 fabric defect detection system

## Body

The YOLOv11 fabric defect detection system is based on the deep learning YOLOv11. The system includes the YOLOv11+YOLO dataset, UI interface, login and registration interface, Python project source code, and model.

The nc:6 class,
Names: ['DaiSha', 'DuanSha', 'MianQiu', 'PoDong', 'TuoSha', 'WuZi'],
Dataset size: 1650 training set, 467 validation set.
